...
%rwdRapid('rewardType=''H''','runNum=2','useStaircase=0','currBal=0','numTrials=17','displayName=''3tb''', 'threshStair1=0.25', 'threshStair2=0.35');
% rwdRapid('rewardType=''H''','runNum=2','useStaircase=0','currBal=0','numTrials=17','displayName=''3tb''', 'threshStair1=0.2', 'threshStair2=0.35');

% rwdRapid('rewardType=''H''','runNum=2','useStaircase=0','currBal=0','numTrials=17','displayName=''3tb''', 'threshStair1=0.15', 'threshStair2=0.38');
