...
binBorders = [0.4 1.3 2 3 5 7 12 20 40 100];
...
save([dataFolder 'rwdRapidData_concatSess_' nullTrialsString globalMeanString '.mat'], 'dataFolder', 'subFolders', 'samplerate', 'roiNames', ...
