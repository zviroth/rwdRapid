...
subFolders = {'008020190509', '008020190411', '008720190503', '008620190410', '005520190411', '007420190221/', '007520190318/', '008320190320/', '009020190325/', '001920190403/'};
subFolders = {'008320190523', '001920190515', '008720190503', '008020190509', '008620190410', '005520190411', '008020190411', '007420190221/', '007520190318/', '008320190320/', '009020190325/', '001920190403/'};
subFolders = {'007420190529', '008320190523', '001920190515', '008720190503', '008020190509', '008620190410', '005520190411', '008020190411', '007420190221/', '007520190318/', '008320190320/', '009020190325/', '001920190403/'};
...
clear designMatContrastFreq designMatNull taskBaseline meanDeconvFreq meanDeconvContrastFreq sfBetas
...
for iSub = 1:numSubs
    ...
    for iScan = 1:nScans%2 concatenations, 1 for each reward type
        ...
        for r=1:length(s)%create design matrices per run
            ...
            %high-pass filter
            deconvMatNullRun = highpassConcat(deconvMatNullRun, concatInfo{iSub,rwdTypeNum}, r);
            ...
            %high-pass filter
            deconvMatContrastRun = highpassConcat(deconvMatContrastRun, concatInfo{iSub,rwdTypeNum}, r);
            ...
            %high-pass filter
            deconvMatFreqRun = highpassConcat(deconvMatFreqRun, concatInfo{iSub,rwdTypeNum}, r);
            ...
            %high-pass filter
            deconvMatContrastFreqRun = highpassConcat(deconvMatContrastFreqRun, concatInfo{iSub,rwdTypeNum}, r);
        ...
        for iRoi=1:numRois
            ...
            for i=1:nvox
                ...
                for r=1:length(s)%create design matrices per run. at the beginning of each run the predictors must be zeroed
                    ...
                    %high-pass filter
                    designMatContrastVoxRun = highpassConcat(designMatContrastVoxRun, concatInfo{iSub,rwdTypeNum}, r);
                    ...
                    %high-pass filter
                    designMatFreqVoxRun = highpassConcat(designMatFreqVoxRun, concatInfo{iSub,rwdTypeNum}, r);
                    ...
                    %high-pass filter
                    designMatContrastFreqVoxRun = highpassConcat(designMatContrastFreqVoxRun, concatInfo{iSub,rwdTypeNum}, r);
                    ...
                    %high-pass filter
                    designMatNullVoxRun = highpassConcat(designMatNullVoxRun, concatInfo{iSub,rwdTypeNum}, r);
...
%high-pass filter
% filteredData = real(ifft(fft(concatData) .* repmat(concatInfo.hipassfilter{irun}, size(concatData,1),1) ));
